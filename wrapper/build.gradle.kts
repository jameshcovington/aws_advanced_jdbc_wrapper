...
dependencies {
    ...
    compileOnly("software.amazon.awssdk:http-client-spi:2.27.12") // Required for IAM (light implementation)
    ...
    testImplementation("software.amazon.awssdk:http-client-spi:2.27.12") // Required for IAM (light implementation)
