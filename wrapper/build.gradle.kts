...
dependencies {
    ...
    compileOnly("software.amazon.awssdk:http-client-spi:2.25.60") // Required for IAM (light implementation)
    ...
    testImplementation("software.amazon.awssdk:http-client-spi:2.25.60") // Required for IAM (light implementation)
