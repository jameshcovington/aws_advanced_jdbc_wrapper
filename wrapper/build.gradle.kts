...
dependencies {
    ...
    compileOnly("software.amazon.awssdk:http-client-spi:2.26.20") // Required for IAM (light implementation)
    ...
    testImplementation("software.amazon.awssdk:http-client-spi:2.26.20") // Required for IAM (light implementation)
