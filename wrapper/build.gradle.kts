...
dependencies {
    ...
    compileOnly("software.amazon.awssdk:http-client-spi:2.27.2") // Required for IAM (light implementation)
    ...
    testImplementation("software.amazon.awssdk:http-client-spi:2.27.2") // Required for IAM (light implementation)
